# 5º MARCO: Documento de Identidade Visual
...
* 🟦 **Azul Noturno (Principal):** `#1E3A8A` - Utilizado para cabeçalhos estruturais e títulos.
* 🔷 **Azul Esportivo (Destaque):** `#3B82F6` - Aplicado em botões secundários, links e estados de hover.
* 🟩 **Verde Gramado (Sucesso):** `#10B981` - Usado para o botão principal de sorteio e cards de equipes formadas.
...
* **Pesos utilizados:** 600 (Semi-Bold), 700 (Bold) e 900 (Black)
* **Aplicação:** Títulos de seções, nomes dos times e logo.

### Textos de Apoio, Formulários e Controles
